#!/usr/bin/env python3
"""
Create Enhanced ML Dataset - Fixed Implementation
================================================

This script creates an enhanced ML-ready dataset with proper feature vector handling:
...
class FixedEnhancedMLDatasetCreator:
    """Create enhanced ML-ready dataset with proper feature vector handling."""
    ...
    def __init__(self, base_path: Path):
        ...
        logger.info("🎯 Fixed Enhanced ML Dataset Creator initialized")
    ...
    def create_enhanced_samples(self, audio_features: List[Dict]) -> List[Dict]:
    ...
    def create_fixed_length_features(self, samples: List[Dict]) -> Tuple[np.ndarray, List[str], List[str]]:
        """Create fixed-length feature vectors for ML."""
        logger.info("🤖 Creating fixed-length ML-ready features...")
        ...
        for sample in samples:
            ...
            if 'tempo' in features:
                feature_vector.append(float(features['tempo']))
            else:
        ...
        logger.info(f"✅ Fixed-length ML-ready features created:")
    ...
    def save_enhanced_dataset(self, samples: List[Dict], splits: Dict, raga_counts: Dict, tradition_counts: Dict):
        ...
        enhanced_dataset = {
            ...
            'dataset_type': 'enhanced_ml_ready_fixed',
        ...
        dataset_path = self.ml_ready_path / "enhanced_ml_ready_dataset_fixed.json"
        ...
        summary_path = self.ml_ready_path / "enhanced_ml_dataset_summary_fixed.json"
...
def main():
    ...
    logger.info("🎯 Create Enhanced ML Dataset - Fixed Implementation")
    logger.info("=" * 70)
    
    # Initialize creator
    base_path = Path("/Users/adhi/axonome/RagaSense-Data")
    creator = FixedEnhancedMLDatasetCreator(base_path)
    ...
    try:
        ...
        # Step 3: Create fixed-length ML-ready features
        X, y_raga, y_tradition = creator.create_fixed_length_features(samples)
        ...
        enhanced_dataset, summary = creator.save_enhanced_dataset(samples, splits, raga_counts, tradition_counts)
